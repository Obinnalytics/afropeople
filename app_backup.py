...
# Template context processor to make AdSense and sidebar data available in all templates
...
if __name__ == '__main__':
    with app.app_context():
        init_db()
    app.run(debug=True) #   P r o f i l e   f u n c t i o n a l i t y   a d d e d   m a n u a l l y  
 